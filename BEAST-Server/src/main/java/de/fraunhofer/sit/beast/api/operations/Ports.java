...
public class Ports
{
    ...
    public PortForwarding createPortForwarding(
		...
		LOGGER.info("Create port forwarding on device " + devid + " using portOnDevice=" + portOnDevice + ", direction=" + direction + ", protocol=" + protocol);
	...
	public void removeForwarding(
		...
		for (PortForwarding p : device.getPortFowardings().listPortForwardings()) {
			...
			{
				LOGGER.info("Create delete forwarding on " + devid + " using portOnDevice=" + p.portOnDevice  + ", portOnHost=" + p.portOnHostMachine + ", direction=" + p.direction + ", protocol=" + p.protocolOnDevice);
