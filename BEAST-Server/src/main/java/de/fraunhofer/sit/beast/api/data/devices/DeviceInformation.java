...
@JsonSubTypes({ @Type(value = AndroidDeviceInformation.class, name = "AndroidDeviceInformation"), })
...
public abstract class DeviceInformation {
	...
	// This field should not be persisted. it is set by the controller when it is
	// forwarded
	@XmlElement
	...
	/**
	 * Updates the last used entry only if the device has been reserved by the given
	 * api key
	 * 
	 * @param apiKey
	 */
